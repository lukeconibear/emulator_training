...
source_dfs_mort = joblib.load('source_dfs_mort_adjusted_scaled_float16_pm25only.joblib.compressed')
options = joblib.load('options.joblib.compressed')

results_china = joblib.load('results_compare_china_adjusted_scaled_float16_nodalys_pm25only.joblib.compressed')
...
def create_interactive_plot(source, output, outcome):
...
def build_visualisation():
    ...
    plot_exposure_PM2_5_DRY = create_interactive_plot(source_exposure_PM2_5_DRY, 'PM2_5_DRY', 'exposure')
    plot_mort_PM2_5_DRY = create_interactive_plot(source_mort_PM2_5_DRY, 'PM2_5_DRY', 'mort')
